...
BRIGHTNESS = 31 # 0 to 31 - 15 is half
...
#         led_strip.set_hsv(i, hsvcolour['hue'], hsvcolour['sat'], hsvcolour['val'])
    print(f"LEDs set to {hex}, hue:{hsvcolour['hue']}, sat: {hsvcolour['sat']}, val: {hsvcolour['val']}, r:{r}, g:{g}, b:{b}")
